<?php
/**
 * The template for displaying tribe archive pages
 */
...
<main id="primary" class="site-main">
    <?php if (have_posts()) : ?>
        <header class="page-header">
            <h1 class="page-title"><?php esc_html_e('Tribes', 'rimal-game'); ?></h1>
            <div class="archive-description">
                <?php esc_html_e('Discover the diverse tribes of Rimal, each with their own unique culture, traditions, and fighting styles.', 'rimal-game'); ?>
            </div>
        </header>

        <?php
        get_template_part('template-parts/archive', 'tribe');
...
<style>
    .page-header {
        ...
        background-image: linear-gradient(rgba(0, 0, 0, 0.6), rgba(0, 0, 0, 0.6)), url('<?php echo esc_url(get_theme_file_uri("assets/images/tribes-bg.jpg")); ?>');
